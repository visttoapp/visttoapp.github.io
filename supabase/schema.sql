-- INSTALAÇÃO NOVA APENAS. No projeto atual, multi-agencias.sql, hierarquia.sql, squads.sql, convites.sql, divisoes.sql, gestores.sql e espaco.sql já foram aplicadas.
begin;
-- =====================================================================
